...
function ApplySkin()
    ...
    RSGCore.Functions.TriggerCallback('rsg-multicharacter:server:getAppearance', function(data)
        ...
        LoadBodyFeature(_Target, _SkinData, #Data.Appearance.body_size)
        LoadBodyFeature(_Target, _SkinData, #Data.Appearance.body_waist)
        LoadBodyFeature(_Target, _SkinData, #Data.Appearance.chest_size)
...
local function ApplySkinMultiChar(SkinData, Target, ClothesData)
    ...
    LoadBodyFeature(Target, SkinData, #Data.Appearance.body_size)
    LoadBodyFeature(Target, SkinData, #Data.Appearance.body_waist)
    LoadBodyFeature(Target, SkinData, #Data.Appearance.chest_size)
